...
#ifdef TARGET_PC
    u32 _pc_magic;       /* sentinel to detect already-processed data */
    void *_pc_raw_data;  /* original decoded buffer, freed by HuSprAnimKill */
#endif
} AnimData; //sizeof 0x14 (GC), larger on PC
